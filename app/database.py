...
SCHEMA_MIGRATIONS = [
    ...
    "ALTER TABLE node_power ADD COLUMN storage_api_url varchar(255) DEFAULT ''",
...
POSTGRES_SCHEMA_MIGRATIONS = [
    ...
    "ALTER TABLE node_power ADD COLUMN IF NOT EXISTS storage_api_url varchar(255) DEFAULT ''",
